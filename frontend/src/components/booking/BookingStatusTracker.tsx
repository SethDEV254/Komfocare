    ...
    <div className="rounded-3xl p-6 sm:p-8 glass-card border border-white/15 shadow-2xl space-y-8">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-white/10">
        ...
        <div className="flex flex-col items-start sm:items-end">
          <span className="text-xs font-mono text-slate-400 mb-1 font-medium">
            Current Status
          </span>

          <span
            className={`inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full text-xs font-bold border ${statusBadge.bg}`}
          >
            <span
              className={`w-2 h-2 rounded-full ${statusBadge.dot} animate-pulse`}
            />
        ...
        <div className="p-5 rounded-2xl bg-rose-500/10 border border-rose-500/30 text-rose-200 text-xs flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 font-sans">
              This request was cancelled. If you need to rebook or have
              questions, please contact our support team at 0792004232.
            </p>
          </div>
        </div>
      )}
          ...
          <div className="flex items-center gap-4 text-left">
            ...
            <div>
              ...
              <p className="text-xs text-slate-300 font-sans">
                {request.assignedProfessional.roleTitle}
              </p>
            </div>
          </div>
